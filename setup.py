...
# Begin setup
setup_keywords = dict()
setup_keywords['name'] = 'cugn'
setup_keywords['description'] = 'Code for using+analyzing the CUGN'
setup_keywords['author'] = 'J. Xavier Prochaska, Dan Rudnick'
setup_keywords['author_email'] = 'jxp@ucsc.edu'
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/AI-for-Ocean-Science/cugn'
...
setup_keywords['install_requires'] = [
    ...
    'xarray', 'h5netcdf',  'gsw',
    'importlib-metadata', 'timm==0.3.2', 'functools']
